...
@Component({
  selector: 'app-headphones-details',
  templateUrl: './headphones-details.component.html',
  styleUrls: ['./headphones-details.component.css']
})
export class HeadphonesDetailsComponent implements OnInit {

  previousUrl!: string;
  constructor(private activatedRoute: ActivatedRoute,
    private productsService: HeadphonesService,
