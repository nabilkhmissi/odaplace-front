...
export class ProductService {
    ...
    getProducts(title_search?: string, size?: number, page?: number, minprice?: number, maxprice?: number, manufacturer?: string) {
        return this.http.get<Response<Product>>(`${this.baseUrl}/products/smartphones?page=${page}&size=${size}&minprice=${minprice}&maxprice=${maxprice}&product_title=${title_search}&manufacturer=${manufacturer}`);
    }
    ...
    getProduct(id: string): Observable<any> {
        return this.http.get<any>(`${this.baseUrl}/products/smartphones/${id}`).pipe(
